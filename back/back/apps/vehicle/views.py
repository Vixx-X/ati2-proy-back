...
class VehiclePostViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['vehicle__brand', 'vehicle__year', "vehicle__model","address__city__name", "address__city__state__name", "address__city__state__country__name", "address__city__state__country__continent__name", "currency","accesories", "services", ]
